...
- [Concat Avg / Max of last n-1 layer (withoutembedding layer)](#Concat-AvgMax-of-last-n-1-layer-withoutembedding-layer)
- [Custom loss (Jaccard-based Soft Labels)](#Custom-lossJaccard-based-Soft-Labels)
- [Pre-training on squad2.0](#Pre-training-on-squad20)
